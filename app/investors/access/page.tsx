...
function DocCard({ title, sub, href, cta, featured, updating, version }:
  { title: string; sub: string; href: string; cta: string; featured?: boolean; updating?: boolean; version?: string }) {
  if (updating) {
    return (
